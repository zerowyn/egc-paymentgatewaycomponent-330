...
public class PaymentBusinessConstant {
    ...
    public static final String COUPON_ID_ = "coupon_id_";
    
    public static final String COUPON_TYPE_ = "coupon_type_";
    
    public static final String COUPON_FEE_ = "coupon_fee_";
