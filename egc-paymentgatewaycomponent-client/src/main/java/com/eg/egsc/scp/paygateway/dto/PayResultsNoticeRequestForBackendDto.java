 ...
 * @Path: com.eg.egsc.scp.paygateway.dtoPayResultsNoticeRequestForWeiXinDto.java
 * @Create By fandong
 * @Create In 2018年2月6日
 * TODO
 */
...
/**
 * @Class Name PayResultsNoticeRequestForWeiXinDto
 * @Author fandong
 * @Create In 2018年2月6日
 */
@Component
public class PayResultsNoticeRequestForBackendDto extends BaseBusinessDto {
