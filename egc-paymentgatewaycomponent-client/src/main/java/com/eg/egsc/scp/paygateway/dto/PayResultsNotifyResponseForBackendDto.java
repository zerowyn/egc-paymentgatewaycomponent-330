 ...
 * @Path: com.eg.egsc.scp.paygateway.dtoPayResultsNotifyResponseForBackendDto.java
 * @Create By fandong
 * @Create In 2018年2月5日
 * TODO
 */
...
/**
 * @Class Name PayResultsNotifyResponseForBackendDto
 * @Author fandong
 * @Create In 2018年2月5日
 */
@Component
public class PayResultsNotifyResponseForBackendDto{
