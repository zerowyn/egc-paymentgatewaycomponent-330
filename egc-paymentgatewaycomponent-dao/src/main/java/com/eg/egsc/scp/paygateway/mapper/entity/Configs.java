...
public class Configs {
    ...
    public String getCodeTypeUuid() {
        return codeTypeUuid;
    }

    public void setCodeTypeUuid(String codeTypeUuid) {
        this.codeTypeUuid = codeTypeUuid;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getUuid() == null ? other.getUuid() == null : this.getUuid().equals(other.getUuid()))
            && (this.getCodeTypeUuid() == null ? other.getCodeTypeUuid() == null : this.getCodeTypeUuid().equals(other.getCodeTypeUuid()))
            && (this.getConfigTypeCode() == null ? other.getConfigTypeCode() == null : this.getConfigTypeCode().equals(other.getConfigTypeCode()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCodeTypeUuid() == null) ? 0 : getCodeTypeUuid().hashCode());
        result = prime * result + ((getConfigTypeCode() == null) ? 0 : getConfigTypeCode().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", codeTypeUuid=").append(codeTypeUuid);
        sb.append(", configTypeCode=").append(configTypeCode);
